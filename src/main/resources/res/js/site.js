...
$(function() {
	...
	var app = {
		...
		evaluator: {
			...
			search: function(jsonpath) {
				var jss;
				this.jsonpath = jsonpath;

				switch (this.mode) {
					case 'json':
						jss = JSONPath(jsonpath, json_data);
						this.render_json(json_data, jss);
						// Developer hint
						console.log('DEV HINT! Try JSONPath from the console directly by pasting this in to edit field:\n',
									'JSONPath("'+ jsonpath +'", json_data)', '->', jss);
						break;
				}
			},
